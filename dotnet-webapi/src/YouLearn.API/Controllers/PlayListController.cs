...
namespace YouLearn.API.Controllers
{
    ...
    public class PlayListController : YouLearnBaseController
    {
        private readonly IServicePlayList _servicePlayList;
        private readonly IHttpContextAccessor _httpContextAccessor;

        public PlayListController(IUnitOfWork unityOfWork, IServicePlayList servicePlayList, IHttpContextAccessor httpContextAccessor)
            : base(unityOfWork)
        {
        ...
        public async Task<IActionResult> Listar()
        {
            try
            {
                ...
                var response = _servicePlayList.Listar(autenticarUsuarioResponse.Id);
        ...
        public async Task<IActionResult> Adicionar([FromBody] AdicionarPlayListRequest request)
        {
            try
            {
                ...
                var response = _servicePlayList.Adicionar(request, autenticarUsuarioResponse.Id);
        ...
        public async Task<IActionResult> Excluir(Guid id)
        {
            try
            {
                var response = _servicePlayList.Excluir(id);
