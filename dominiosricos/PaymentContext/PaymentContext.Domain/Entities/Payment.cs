...
namespace PaymentContext.Domain.Entities
{
    ...
    {
        protected Payment(DateTime paidDate, DateTime expireDate, decimal total, decimal totalPaid, string payer, Address address, string owner, Document document, Email email)
        {
