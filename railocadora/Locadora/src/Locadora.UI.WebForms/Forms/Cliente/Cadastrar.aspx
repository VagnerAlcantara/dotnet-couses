<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Cadastrar.aspx.cs" Title="Cliente" Inherits="Locadora.UI.WebForms.Forms.Cliente.Cadastrar" MasterPageFile="~/Site.Master" %>
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div >
                    ...
                    <asp:TextBox runat="server" TextMode="Date" MaxLength="15" CssClass="form-control input-small" ID="txtDataNascimento" aria-describedby="dataNascimentoHelp" value="" />
                </div>
                <div >
